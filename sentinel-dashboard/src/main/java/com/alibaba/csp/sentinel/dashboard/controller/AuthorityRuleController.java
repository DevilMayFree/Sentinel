...
public class AuthorityRuleController {
    ...
    private boolean publishRules_persistence(/*@NonNull*/ String app) {
        logger.info("AuthorityRuleController publishRules_persistence .app:{}",app);
        List<AuthorityRuleEntity> rules = repository.findAllByApp(app);
        logger.info("AuthorityRuleController publishRules_persistence .list-AuthorityRuleEntity:{}",rules);
